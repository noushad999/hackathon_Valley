      ...
      <Tabs defaultValue="profile" className="space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {[
                ...
                { title: "Browser Notifications", description: "Receive notifications in your browser" },
              ].map((item, i) => (
        ...
        <TabsContent value="display" className="space-y-4">
          <Card>
            ...
            <CardContent className="space-y-4">
              {[
                { title: "Dark Mode", description: "Toggle between light and dark mode" },
                { title: "Compact View", description: "Use a more compact layout" },
                { title: "Show Status", description: "Show your online status to others" },
                { title: "Animations", description: "Enable animations throughout the interface" },
              ].map((item, i) => (
                <div key={i} className="flex items-center justify-between">
                  <div className="space-y-0.5">
                    <div className="font-medium">{item.title}</div>
